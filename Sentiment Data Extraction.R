...
# 
namo <- searchTwitter('narendra modi', n=30, lang="en")
# length (namo)
# namo
...
ktk8 <- searchTwitter('#delhielection2020', n=no.of.tweets, lang="en")

bjp <- searchTwitter('bjp', n=100, lang="en")
congress <- searchTwitter('congress', n=100, lang="en")
namo <- searchTwitter('narendra modi', n=100, lang="en")
raga <- searchTwitter('rahul gandhi', n=100, lang="en")
